...
function loadPlaces(map) {
	...
	_axios2.default.get('/api/stores/near?lat=' + lat + '&lng=' + lng).then(function (res) {
		...
		var markers = places.map(function (place) {
			...
			// extends map viewbox bounds to include the point for max visibility
		...
		//When someone clicks marker, show details window
		...
		// Zoom map to fit all the markers centered
